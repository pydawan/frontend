...
// -- index.html is opened when a user visits the documentation site. It redirects to the latest version of documentation.
...
fse.writeFileSync(`${buildDir}/index.html`, indexFile);
